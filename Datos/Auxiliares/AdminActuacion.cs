...
namespace Lexus2_0.Datos.Auxiliares
{
    public class AdminActuacion
    {
         ...
         * 1.- LLEGA UN NUEVO OFICIO, ABRE UNA FECHA DE TÉRMINO
         * 2.- DEPENDIENDO DE QUÉ ASUNTO, SE TRAMITA A OTRAS ÁREAS, 'CONGELANDO' LA FECHA DE TÉRMINO (ESTO ES, AUNQUE SE HAYA VENCIDO, NO CUENTA EN LOS INFORMES NI NOTIFICACIONES)
         * 3.- SE RECIBE LA RESPUESTA DEL ÁREA A QUIEN SE LE TRAMITÓ
         * 4.- SE RESPONDE EL OFICIO INICIAL, SE ELIMINA EL TÉRMINO.
         * 
         * D) CASO ANORMAL, PERO POSIBLE DE TAFP            (RECEPCIÓN => EN TRÁMITE => RECEPCIÓN => REQUERIMIENTO DE RESPUESTA => RESPUESTA DEL TRÁMITE => RESPUESTA
         * 1.- LLEGA UN NUEVO OFICIO, ABRE UNA FECHA DE TÉRMINO
