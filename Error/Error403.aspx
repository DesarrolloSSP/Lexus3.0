<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Error403.aspx.cs" Inherits="Lexus2._0.Error.Error403" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <h1>403</h1>
            <p><strong>Acceso Denegado:</strong> No tienes los permisos necesarios para visualizar este recurso o se requiere autenticación.</p>
