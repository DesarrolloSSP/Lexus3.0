...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:HiddenField ID="hfIdExped" runat="server" />
    ...
    <section>
        <h2 class="text-center p-1 fw-bold mb-2" style="color: #6D132D !important">EDICIÓN DE DOCUMENTO</h2>
        <h6 class="text-center p-1">FORMULARIO DE EDICIÓN DE DOCUMENTO. ESTE FORMULARIO SE ENCUENTRA SEGMENTADO EN 2 PARTES: PROCEDENCIA Y DATOS DEL DOCUMENTO..</h6>
    ...
    <asp:Panel ID="pnl_msj" runat="server" CssClass="modalPopupGigante" Style="display: none">
        ...
        <div style="width: 100%; text-align: center;">
            <asp:Button ID="btn_Ok" runat="server" CssClass="btn btn-primary" Text="ACEPTAR" />
        </div>
    </asp:Panel>
    <asp:Button ID="btn_dummy" runat="server" Style="display: none" />

    <ajaxToolkit:ModalPopupExtender ID="mpe_Finalizacion" runat="server" PopupControlID="pnl_Final" OkControlID="btn_OkFin" TargetControlID="btn_dummyFin" BackgroundCssClass="modalBackground">
    </ajaxToolkit:ModalPopupExtender>
    <asp:Panel ID="pnl_Final" runat="server" CssClass="modalPopupGigante" Style="display: none">
        <asp:UpdatePanel ID="upMsjFin" runat="server">
            <ContentTemplate>
                <br />
                <asp:Label ID="lbl_msj_Fin" runat="server"></asp:Label>
                <hr />
                <div style="width: 100%; text-align: center;">
                    <asp:Button ID="btn_OkFin" runat="server" CssClass="btn btn-primary" OnClick="btn_OkFin_Click" Text="ACEPTAR" />
                </div>
            </ContentTemplate>
        </asp:UpdatePanel>
    </asp:Panel>
    <asp:Button ID="btn_dummyFin" runat="server" Style="display: none" />
                ...
                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab" tabindex="0">
                    <div class=" d-flex justify-content-center ">
                        <div class="container">
                            ...
                            <asp:UpdatePanel runat="server" ID="t">
                                <ContentTemplate>
                                    <div class="panel-body">
                                        <section>
                                            <fieldset class="scheduler-border">
                                                <legend class=" pt-3 fw-bold" style="color: #6D132D !important">TIPO DE ACTUACIÓN</legend>
                                                <asp:Label ID="Label112" runat="server" Text="ACTUACIÓN" AssociatedControlID="ddlActuacion" />
                                                <asp:DropDownList ID="ddlActuacion" CssClass="form-select" runat="server" DataSourceID="edsActuacion" DataTextField="actuacion" DataValueField="id" Width="100%" Enabled="false">
                                                </asp:DropDownList>
                                                <asp:EntityDataSource runat="server" ID="edsActuacion" DefaultContainerName="BDJuridicoEntities"
                                                    ConnectionString="name=BDJuridicoEntities" EnableFlattening="False" EntitySetName="catActuaciones"
                                                    EntityTypeFilter="catActuaciones" OrderBy="it.actuacion">
                                                </asp:EntityDataSource>
                                            </fieldset>

                                            <fieldset class="scheduler-border">
                                                <legend class=" pt-3 fw-bold" style="color: #6D132D !important">DATOS INICIALES</legend>
                                                ...
                                                <asp:DropDownList ID="ddlAreaAsignada" CssClass="form-select" runat="server" DataTextField="nombre" OnDataBound="ddlAreaAsignada_DataBound"
                                                ...
                                                <div id="divSubarea" runat="server" visible="false">
                                                    <asp:Label ID="Label5" runat="server" Font-Size="0.8em" Text="Sub-área" AssociatedControlID="ddlSubAre"></asp:Label><span class="campoRequerido">*</span><br />
                                                    <asp:DropDownList ID="ddlSubAre" runat="server" CssClass="form-select"
                                                        Width="82%" AutoPostBack="true" DataSourceID="edsSubAreas" DataTextField="nombre" DataValueField="id" class="form-select">
                                                    </asp:DropDownList>
                                                    <asp:EntityDataSource runat="server" ID="edsSubAreas" DefaultContainerName="BDJuridicoEntities"
                                                        Where="it.id IN {17127, 17128, 17129, 17130, 17131}"
                                                        ConnectionString="name=BDJuridicoEntities" EnableFlattening="False" EntitySetName="tbOrganismos">
                                                    </asp:EntityDataSource>
                                                </div>
                                                <br />
                                                <asp:Label ID="lblMsjCambioArea" runat="server" Text="PARA PODER CAMBIAR EL ÁREA SE REQUIERE DE UNA CUENTA DE ADMINISTRADOR DE DEPARTAMENTO" ForeColor="Red"></asp:Label>
                                                <asp:EntityDataSource runat="server" ID="edsOrgAsignada" DefaultContainerName="BDJuridicoEntities" ConnectionString="name=BDJuridicoEntities" EnableFlattening="False"
                                                    EntitySetName="tbOrganismos" EntityTypeFilter="tbOrganismos" Where="it.id IN {63, 67, 70, 73, 450, 61, 76}">
                                                </asp:EntityDataSource>
                                                <br />
                                                <div id="divProcedenciaTodos" runat="server">
                                                    ...
                                                    <asp:TextBox TabIndex="1" ID="txtOrgProcedencia" runat="server" CssClass="form-control " placeholder="COMIENCE A ESCRIBIR LA PROCEDENCIA..." Style="width: 100%;"
                                                        autocomplete="off" TextMode="MultiLine" Height="8em"></asp:TextBox>
                                                    <asp:HiddenField ID="hfidOrgProced" runat="server" />
                                                </div>
                                                <div id="divProcedenciaDDH" runat="server">
                                                ...
                                                <div id="divDestino" runat="server">
                                                    <asp:Label ID="Label7" runat="server" Font-Size="0.8em" Text="DESTINO" AssociatedControlID="txtOrgDestino"></asp:Label><span class="campoRequerido">*</span>
                                                    <asp:TextBox TabIndex="1" ID="txtOrgDestino" runat="server" CssClass="form-control " placeholder="COMIENCE A ESCRIBIR EL DESTINO..." Style="width: 100%;"
                                                        autocomplete="off" TextMode="MultiLine" Height="8em"></asp:TextBox>
                                                    <asp:HiddenField ID="hfidOrgDestino" runat="server" />
                                                </div>
                                                <div id="divTipoAsunto" runat="server">
                                                    ...
                                                    <asp:EntityDataSource runat="server" ID="edsTipoAsunto" DefaultContainerName="BDJuridicoEntities" ConnectionString="name=BDJuridicoEntities"
                                                        ...
                                                        Where=" (it.id == @idTipo)" OrderBy="it.tipo">
                                                        <WhereParameters>
                                                            <asp:ControlParameter ControlID="ddlAreaAsignada" Name="idAreaJuridica" Type="Int32" DefaultValue="0" />
                                                            <asp:SessionParameter SessionField="idTipo" DefaultValue="0" Name="idTipo" Type="Int32"></asp:SessionParameter>
                                                        </WhereParameters>
                                                    </asp:EntityDataSource>
                                                    <hr />
                                                    ...
                                                    <asp:Repeater ID="repInformacionTipoAsunto" runat="server"
                                                        ...
                                                        <ItemTemplate>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                                    <asp:LinkButton ID="btnBorrarDatoST" runat="server" CssClass="btn btn-primary" ToolTip="ELIMINAR DATO" ClientIDMode="AutoID"
                                                        ...
                                                        <FooterTemplate>
                                                            ...
                                                            <div style="text-align: right; padding-top: 20px;">
                                                                <asp:LinkButton ID="btnAgregarInfoTipoAsunto" runat="server" CssClass="btn btn-primary"
                                            ...
                                            <fieldset class="scheduler-border">
                                                <legend class=" pt-3 fw-bold" style="color: #6D132D !important">PERSONAS
                                                </legend>
                                                <div style="padding-bottom: 20px;">
                                                    Se muestra el nombre de las personas relacionadas
                                                </div>
                                                ...
                                                <section class="shadow p-3 mb-5 bg-white rounded">
                                                    ...
                                                    <div class="row pb-2">
                                                        ...
                                                        <div class="col-md">
                                                            <asp:LinkButton ID="btnAgregarPersona" runat="server" CssClass="btn btn-primary" OnClick="btnAgregarPersona_Click">
  ...
  <path d="M2 7v-.839c.457.432 1.004.751 1.49.972C4.722 7.693 6.318 8 8 8s3.278-.307 4.51-.867c.486-.22 1.033-.54 1.49-.972V7c0 .424-.155.802-.411 1.133a4.51 4.51 0 0 0-4.815 1.843A12.31 12.31 0 0 1 8 10c-1.573 0-3.022-.289-4.096-.777C2.875 8.755 2 8.007 2 7Zm6.257 3.998L8 11c-1.682 0-3.278-.307-4.51-.867-.486-.22-1.033-.54-1.49-.972V10c0 1.007.875 1.755 1.904 2.223C4.978 12.711 6.427 13 8 13h.027a4.552 4.552 0 0 1 .23-2.002Zm-.002 3L8 14c-1.682 0-3.278-.307-4.51-.867-.486-.22-1.033-.54-1.49-.972V13c0 1.007.875 1.755 1.904 2.223C4.978 15.711 6.427 16 8 16c.536 0 1.058-.034 1.555-.097a4.507 4.507 0 0 1-1.3-1.905Z"/>
                                                    ...
                                                    <asp:GridView runat="server" ID="gvPersonasRelacionadas"
                                                        CssClass="table table-bordered table-responsive-sm"
                                                        AutoGenerateColumns="false" OnRowCommand="gvPersonasRelacionadas_RowCommand" DataKeyNames="id">
                                                        <Columns>
                                                            <asp:BoundField DataField="nombreCompleto" HeaderText="Nombre" SortExpression="nombreCompleto"></asp:BoundField>
                                                            <asp:BoundField DataField="figura" HeaderText="Figura" SortExpression="figura"></asp:BoundField>
                                                            <asp:TemplateField ShowHeader="False">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton runat="server" CssClass="btn btn-danger" Text="Eliminar" CommandName="EliminarRegistroPersona" CausesValidation="False" ID="lkbEditar" ToolTip="Editar" CommandArgument='<%# Eval("id") %>'>
                            ...
                            <asp:UpdatePanel ID="upSeccion_Actuacion" runat="server">
                                <ContentTemplate>
                                    <div class="panel-body">
                                        ...
                                        <asp:TextBox ID="txtDocPersonaRecibio" runat="server" CssClass="form-control" placeholder=" " Style="width: 100%;" autocomplete="off"></asp:TextBox>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-5 col-md-4 col-sm-12 col-xs-12">
                                                    <label class="placeHolder">
                                                        <asp:TextBox ID="txtNumDocto" runat="server" CssClass="form-control" placeholder=" " Style="width: 20em;" autocomplete="off"></asp:TextBox>
                                                        <span class="textoPlaceHolder">NÚMERO DE DOCUMENTO<span class="campoRequerido">*</span></span>
                                                    </label>
                                                    <label class="placeHolder">
                                                        <asp:TextBox ID="txtFechaRealizacionDocto" runat="server" CssClass="form-control" placeholder=" " Style="width: 20em;" autocomplete="off"></asp:TextBox>
                                                    ...
                                                    <label class="placeHolder">
                                                        <asp:TextBox ID="txtFechaRecepcionDocto" runat="server" CssClass="form-control" placeholder=" " Style="width: 20em;" autocomplete="off"></asp:TextBox>
                                                    ...
                                                    <asp:DropDownList ID="ddlTipoRecep" runat="server" AppendDataBoundItems="true" DataSourceID="edsTipoRecepcionDocumento"
                                                        ...
                                                        DataTextField="tipo" DataValueField="id" Width="80%">
                                                        <asp:ListItem Text="-SELECCIONE-" Value="0"></asp:ListItem>
                                                    </asp:DropDownList>
                                                ...
                                                <div class="col-lg-7 col-md-8 col-sm-12 col-xs-12">
                                                    <label class="placeHolder">
                                                        <asp:TextBox ID="txtAsuntoDoc" runat="server" CssClass="form-control" placeholder=" " Style="width: 35em; height: 26em;" autocomplete="off" TextMode="MultiLine"></asp:TextBox>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                    <div id="divSiTermino" runat="server">
                                                        ...
                                                        <%-- <button id="btnVisualizarTermino" runat="server" class="btn btn-primary" onserverclick="btnVisualizarTermino_ServerClick">
                                                                    <span class="glyphicon glyphicon-calendar" aria-hidden="true" style="font-size: 15px;"></span>
                                                                </button>--%>
                                                    </div>
                                                    <br />
                ...
                <ContentTemplate>
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <asp:LinkButton runat="server" ID="btnlnkaceptar" OnClick="btn_OkFin_Click" CssClass="btn btn-success">Aceptar</asp:LinkButton>
                        </div>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
